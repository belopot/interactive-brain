module.exports = function ( grunt ) {
	...
	grunt.initConfig( {
		...
		concat: {
			...
			build: {
				src: [ 'js/neuron.js', 'js/activeSignal.js', 'js/staticSignal.js', 'js/particlePool.js', 'js/particle.js', 'js/activeAxon.js', 'js/axon.js', 'js/comment.js', 'js/conbox.js', 'js/neuralNet.js',
						 'js/loaders.js', 'js/scene.js', 'js/main.js', 'js/gui.js', 'js/run.js', 'js/events.js', 'js/dataSetAPI.js' ],
